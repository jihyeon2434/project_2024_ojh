...
<section class="mt-8 text-xl px-4">
  ...
  <div class="all-content">
    <form action="../article/doModify" method="POST">
      ...
      <div class="top-box">
        ...
        <div class="title-box-1">
          ...
          <div><input class="input input-bordered input-primary w-full max-w-xs" autocomplete="off" type="text" placeholder="제목을 입력해주세요" name="title" value="${article.title }" /></div>
      ...
      <div class="body-box">
        <div>
          <input class="input input-bordered input-primary" autocomplete="off" type="text" placeholder="내용을 입력해주세요" name="body" value="${article.body }" />
        </div>
      </div>
       <div class="line2"></div>
    ...
    <div class="under-box">
      <div class="good"> <button id="likeButton" class="btn-success" onclick="doGoodReaction(${param.id})">좋아요</button>

...
(
    ...
    `roadName_num`       VARCHAR(100)    NOT NULL    COMMENT '위치(도로명주소)', 
    `review`             VARCHAR(300)    NULL        COMMENT '리뷰', 
    `photoUrl1`          VARCHAR(200)    NULL        COMMENT '사진 URL 1', 
    `photoUrl2`          VARCHAR(200)    NULL        COMMENT '사진 URL 2', 
    `photoUrl3`          VARCHAR(200)    NULL        COMMENT '사진 URL 3', 
    `photoUrl4`          VARCHAR(200)    NULL        COMMENT '사진 URL 4', 
    `photoUrl5`          VARCHAR(200)    NULL        COMMENT '사진 URL 5', 
    ...
    `operateTime`        VARCHAR(50)     NULL        COMMENT '영업시간', 

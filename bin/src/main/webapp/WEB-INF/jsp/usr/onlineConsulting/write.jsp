...
<div class="write-box">
	<div class="write-container">
		<section class="mt-8 text-xl px-4">
			<div class="mx-auto">
				<div>${currentId }</div>
				<form action="../onlineConsulting/doWrite" method="POST" onsubmit="ArticleWrite__submit(this); return false;"
	...
	<!-- 			<div class="photo-guide-divider"></div> -->
				<div class="photo-guide-section-content">
					...
					<p class="photo-guide-section-text">
						어깨 쇄골이 보이는 타이트한 민무늬 검정 민소매를 착용해주세요.(필수)<br><br> - 잘못된 의상 착용 시 분석 정확도가 떨어질 수 있습니다.<br> <br><br> 무늬 없는 배경/밝은
						곳에서 촬영해주세요.<br><br> - 사진이 어두우면 불석 정확도가 떨어집니다.<br><br> <br> 후면/기본 카메라 모드(광각X)<br> <br><br> 간단한 데일리 메이크업
						또는 맨 얼굴로 촬영해주세요.<br>
					</p>
				</div>
			</section>
